...
public class ExceptionMiddleware
{
    ...
    public ExceptionMiddleware(RequestDelegate next, ILogger<ExceptionMiddleware> logger, IActionResultExecutor<ObjectResult> executor, RecyclableMemoryStreamManager recyclableMemoryStreamManager)
    {
        _next = next;
        _logger = logger;
        _executor = executor;
    ...
    private async Task LogResponseAsync(HttpContext context)
    {
        ...
        await using (var responseStream = _recyclableMemoryStreamManager.GetStream())
        {
            ...
            var queryStringNullOrNot = context.Request.QueryString.HasValue ? context.Request.QueryString.Value : "No query string";
